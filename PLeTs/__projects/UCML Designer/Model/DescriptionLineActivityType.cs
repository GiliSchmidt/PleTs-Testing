...
{
    class DescriptionLineActivityType : UcmlObject
    {
        ...
        public LoopQuantityCircle MyLoopQuantityCircle { get; set; }

        public DescriptionLineActivityType()
            : base()
        {
        ...
        public DescriptionLineActivityType ImportToXml(XmlNode xn)
        {
