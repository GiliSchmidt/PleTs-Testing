...
lr_start_transaction("uc_ootb_wf_assignresource");
...
"Resource=0",
"RecContentType=text/html",
"Referer=http://{server_server}/Core/UI/uiHomePage.aspx?rId={{rid}}&sno={sno}&ui=W&portalTemplateId=0628c578-1126-45d2-980c-bf817e7afc12&isUserDefined=True",
				"Mode=HTTP",
LAST);
...
lr_think_time(1);
	...
	lr_start_transaction("OOTB_OpenAssignResource");
		lr_start_sub_transaction("ApproveStep_aspx", "OOTB_OpenAssignResource");
			web_url("ApproveStep.aspx",
				"URL=http://{server_server}/WorkflowManagement/Action/ApproveStep.aspx?rId={{rid}}&sno={sno}&ui=W&StepInstanceId={{processstepinstanceid}}&StepType=RT&ProcessId={processid}&Entity=RESOURCEREQUEST&ProcessStepId={processstepid}&EntityId={entityid}",
				"Resource=0",
				"RecContentType=text/html",
				"Referer=",
				"Mode=HTTP",
	...
	lr_end_transaction("OOTB_OpenAssignResource",LR_AUTO);


	lr_think_time(15);


	lr_start_transaction("OOTB_AssignResource");
		lr_start_sub_transaction("ApproveStep_aspx_2", "OOTB_AssignResource");
			web_submit_data("ApproveStep.aspx_2",
				"Action=http://{server_server}/WorkflowManagement/Action/ApproveStep.aspx?rId={{rid}}&sno={sno}&ui=W&StepInstanceId={{processstepinstanceid}}&StepType=RT&ProcessId={processid}&Entity=RESOURCEREQUEST&ProcessStepId={processstepid}&EntityId={entityid}",
				"Method=GET",
				"RecContentType=text/html",
				"Referer=http://{server_server}/WorkflowManagement/Action/ApproveStep.aspx?rId={{rid}}&sno={sno}&ui=W&StepInstanceId={{processstepinstanceid}}&StepType=RT&ProcessId={processid}&Entity=RESOURCEREQUEST&ProcessStepId={processstepid}&EntityId={entityid}",
				"Mode=HTTP",
				ITEMDATA,
				"Name=_VIEWSTATE", "Value={viewstate_form12}", ENDITEM,
				"Name=EVENTVALIDATION", "Value={eventvalidation_form13}", ENDITEM,
				"Name=TextInstruction", "Value=Please search and assign resource for this request.\r\n\r\nIf more information is required , please select \"Route To\".\r\n\r\nIf you want to cancel this request, please select \"Cancellled\".\r\n\r\nIf you have assigned an internal resource, and want approve the request, please select \"Approved\"", ENDITEM,
	...
	lr_end_transaction("OOTB_AssignResource",LR_AUTO);
	...
	lr_end_transaction("uc_ootb_wf_assignresource",LR_AUTO);
