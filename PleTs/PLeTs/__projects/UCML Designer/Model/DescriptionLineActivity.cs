...
{
    class DescriptionLineActivity : UcmlObject
    {
        ...
        public DescriptionLineActivity()
            : base()
        {
        ...
        public DescriptionLineActivity Clone(UcmlObject obj)
        {
            var newObj = new DescriptionLineActivity();
            var aux = (DescriptionLineActivity)obj;
        ...
        public DescriptionLineActivity ImportToXml(XmlNode xn)
        {
